...
**✨ 《红楼梦》的剧情模式模式现已上线！**  
在这一全新的剧情模式中，你将踏入《红楼梦》的世界，肩负一个清晰而宏大的目标: 复兴大观园。你可以向 AI 下达任何行动指令，而 AI 会根据你的选择模拟后续发展，并判断这些行为将如何推动，或改变，这场复兴计划。

我们还加入了故事回溯功能，让你能够回到任意一个过去的节点，重新作出选择。随着剧情不断推进，你的每一次决定都会延展出新的分支，最终形成一棵可游玩、可回溯的叙事树，让整个体验成为一场真正不断演化的故事冒险。
##
